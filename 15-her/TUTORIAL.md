...
$$r(s',g)=-\mathbf1[\|\operatorname{achieved}(s')-g\|_2>0.05].$$
...
\tilde a'=\operatorname{clip}(\mu_{\bar\theta}(s',g')+\text{clipped noise},-1,1).$$

$$L_Q=\mathbb E_{\mathcal B_{\rm original}\cup\mathcal B_{\rm HER}}
