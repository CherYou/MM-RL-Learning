...
python 12-harness-rl/train.py
# 每次运行自动生成唯一 runs/ 子目录，替换下方实际路径
python 12-harness-rl/eval.py --checkpoint runs/<本次实验>/checkpoint-final --limit 32
```
...
# .venv/bin/arl train 12-harness-rl/verl-gpu.yaml --verl-workers 2
```
